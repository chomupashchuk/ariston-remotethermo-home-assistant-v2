...
SENSORS = {
    ...
    PARAM_CH_ENERGY_LAST_7_DAYS: [SENSOR_CH_ENERGY_LAST_7_DAYS, DEVICE_CLASS_ENERGY, "mdi:cash", None],
    PARAM_DHW_ENERGY_LAST_7_DAYS: [SENSOR_DHW_ENERGY_LAST_7_DAYS, DEVICE_CLASS_ENERGY, "mdi:cash", None],
    ...
    PARAM_CH_ENERGY2_TODAY: [SENSOR_CH_ENERGY2_TODAY, DEVICE_CLASS_ENERGY, "mdi:cash", STATE_CLASS_TOTAL_INCREASING],
    PARAM_DHW_ENERGY2_TODAY: [SENSOR_DHW_ENERGY2_TODAY, DEVICE_CLASS_ENERGY, "mdi:cash", STATE_CLASS_TOTAL_INCREASING],
    PARAM_CH_ENERGY2_YESTERDAY: [SENSOR_CH_ENERGY2_YESTERDAY, DEVICE_CLASS_ENERGY, "mdi:cash", None],
    PARAM_DHW_ENERGY2_YESTERDAY: [SENSOR_DHW_ENERGY2_YESTERDAY, DEVICE_CLASS_ENERGY, "mdi:cash", None],
    PARAM_CH_ENERGY2_LAST_7_DAYS: [SENSOR_CH_ENERGY2_LAST_7_DAYS, DEVICE_CLASS_ENERGY, "mdi:cash", None],
    PARAM_DHW_ENERGY2_LAST_7_DAYS: [SENSOR_DHW_ENERGY2_LAST_7_DAYS, DEVICE_CLASS_ENERGY, "mdi:cash", None],
    PARAM_CH_ENERGY2_THIS_MONTH: [SENSOR_CH_ENERGY2_THIS_MONTH, DEVICE_CLASS_ENERGY, "mdi:cash", None],
    PARAM_CH_ENERGY2_LAST_MONTH: [SENSOR_CH_ENERGY2_LAST_MONTH, DEVICE_CLASS_ENERGY, "mdi:cash", None],
    PARAM_DHW_ENERGY2_THIS_MONTH: [SENSOR_DHW_ENERGY2_THIS_MONTH, DEVICE_CLASS_ENERGY, "mdi:cash", None],
    PARAM_DHW_ENERGY2_LAST_MONTH: [SENSOR_DHW_ENERGY2_LAST_MONTH, DEVICE_CLASS_ENERGY, "mdi:cash", None],
    PARAM_CH_ENERGY2_THIS_YEAR: [SENSOR_CH_ENERGY2_THIS_YEAR, DEVICE_CLASS_ENERGY, "mdi:cash", None],
    PARAM_CH_ENERGY2_LAST_YEAR: [SENSOR_CH_ENERGY2_LAST_YEAR, DEVICE_CLASS_ENERGY, "mdi:cash", None],
    PARAM_DHW_ENERGY2_THIS_YEAR: [SENSOR_DHW_ENERGY2_THIS_YEAR, DEVICE_CLASS_ENERGY, "mdi:cash", None],
    PARAM_DHW_ENERGY2_LAST_YEAR: [SENSOR_DHW_ENERGY2_LAST_YEAR, DEVICE_CLASS_ENERGY, "mdi:cash", None],
    PARAM_CH_ENERGY_DELTA_TODAY: [SENSOR_CH_ENERGY_DELTA_TODAY, DEVICE_CLASS_ENERGY, "mdi:cash", STATE_CLASS_TOTAL_INCREASING],
    PARAM_DHW_ENERGY_DELTA_TODAY: [SENSOR_DHW_ENERGY_DELTA_TODAY, DEVICE_CLASS_ENERGY, "mdi:cash", STATE_CLASS_TOTAL_INCREASING],
    PARAM_CH_ENERGY_DELTA_YESTERDAY: [SENSOR_CH_ENERGY_DELTA_YESTERDAY, DEVICE_CLASS_ENERGY, "mdi:cash", None],
    PARAM_DHW_ENERGY_DELTA_YESTERDAY: [SENSOR_DHW_ENERGY_DELTA_YESTERDAY, DEVICE_CLASS_ENERGY, "mdi:cash", None],
    PARAM_CH_ENERGY_DELTA_LAST_7_DAYS: [SENSOR_CH_ENERGY_DELTA_LAST_7_DAYS, DEVICE_CLASS_ENERGY, "mdi:cash", None],
    PARAM_DHW_ENERGY_DELTA_LAST_7_DAYS: [SENSOR_DHW_ENERGY_DELTA_LAST_7_DAYS, DEVICE_CLASS_ENERGY, "mdi:cash", None],
    PARAM_CH_ENERGY_DELTA_THIS_MONTH: [SENSOR_CH_ENERGY_DELTA_THIS_MONTH, DEVICE_CLASS_ENERGY, "mdi:cash", None],
    PARAM_CH_ENERGY_DELTA_LAST_MONTH: [SENSOR_CH_ENERGY_DELTA_LAST_MONTH, DEVICE_CLASS_ENERGY, "mdi:cash", None],
    PARAM_DHW_ENERGY_DELTA_THIS_MONTH: [SENSOR_DHW_ENERGY_DELTA_THIS_MONTH, DEVICE_CLASS_ENERGY, "mdi:cash", None],
    PARAM_DHW_ENERGY_DELTA_LAST_MONTH: [SENSOR_DHW_ENERGY_DELTA_LAST_MONTH, DEVICE_CLASS_ENERGY, "mdi:cash", None],
    PARAM_CH_ENERGY_DELTA_THIS_YEAR: [SENSOR_CH_ENERGY_DELTA_THIS_YEAR, DEVICE_CLASS_ENERGY, "mdi:cash", None],
    PARAM_CH_ENERGY_DELTA_LAST_YEAR: [SENSOR_CH_ENERGY_DELTA_LAST_YEAR, DEVICE_CLASS_ENERGY, "mdi:cash", None],
    PARAM_DHW_ENERGY_DELTA_THIS_YEAR: [SENSOR_DHW_ENERGY_DELTA_THIS_YEAR, DEVICE_CLASS_ENERGY, "mdi:cash", None],
