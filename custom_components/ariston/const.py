...
PARAM_CH_ENERGY_THIS_WEEK = 'ch_energy_this_week'
PARAM_CH_ENERGY_LAST_WEEK = 'ch_energy_last_week'
PARAM_DHW_ENERGY_THIS_WEEK = 'dhw_energy_this_week'
PARAM_DHW_ENERGY_LAST_WEEK = 'dhw_energy_last_week'
